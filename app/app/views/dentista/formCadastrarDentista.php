...
<html>
    ...
    <body>      
        <form id="container" name="formCadastrarDentista" method="POST" action="app/controller/dentista/procInserirDentista.php">
                <fieldset>
                    <legend>&nbsp;&nbsp;Informe os dados do Dentista: &nbsp;&nbsp;</legend>
                    <br /> 
                    <label>
                        <span>Nome:</span>
                        <input type="text" size=50 name="nome_dentista" />        
                    </label>                     
                    <br />
                    <br />
                    <label>
                    ...
                    <label>
                        ...
                        <input type="text" id="campoData" class="jData" name="dt"/>
                    </label>                     
                    <br />   
                    <br />   
                    <label>
                    ...
                    <label>
                        <span>Cidade:</span>
                        &nbsp;&nbsp;<input id="cidade" size=30 type="text" name="cod_cidade"/>
                    </label>
                    <label>
                        <span>Bairro:</span>
                    ...
                    <label>
                        <span>Estado:</span>
                        <input id="uf" size=5 type="text" name="sigla_uf"/>
                    </label>                    
                    <br />
                    <br /> 
                    <label>
                    ...
                    <label>
                        <span>Celular:</span>
                        <input type="text" class="campoTelefone" name="celular"/>
                    </label>
                    <br /> 
                    <br />
                    <label>

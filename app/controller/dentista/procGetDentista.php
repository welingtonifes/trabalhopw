<?php 
    ...
    require ("getDadosDentista.php");
?>
<!DOCTYPE html>
<html>
    <head>
        <meta http-equiv="content-type" content="text/html;charset=utf-8" />
        <title>ALTERANDO DENTISTA</title>         
    </head>
    <body> 
        <form id="container" name="formGetDentista" method="POST" action="app/controller/dentista/procAlterarDentista.php">
                <fieldset>
                    <legend>&nbsp;&nbsp;Dados do Dentista para alterar: &nbsp;&nbsp;</legend>
                    <br /> 
                    <br />
                    <label>
                        <span>Nome:</span>
                    ...
                    <label>
                        ...
                        <input type="text" id="campoData" class="jData" name="dt" value="<?php echo $my['dt']; ?>"/> 
                    </label>                     
                    <br />   
                    <br />   
                    <label>
                    ...
                    <label>
                        <span>Cidade:</span>
                        <input id="cidade" size=30 type="text" name="cidade" value="<?php echo $my['cod_cidade']; ?>"/> 
                    </label>
                    <label>
                        <span>Bairro:</span>
                    ...
                    <label>
                        <span>Estado:</span>
                        <input id="uf" size=5 type="text" name="uf" value="<?php echo $my['sigla_uf']; ?>"/> 
                    </label>                    
                    <br />
                    <br /> 
                    <label>
                    ...
                    <label>
                        <span>Celular:</span>
                        <input type="text" class="campoTelefone" name="celular" value="<?php echo $my['celular']; ?>"/> 
                    </label>
                    <label>
                        <span>Status:</span>

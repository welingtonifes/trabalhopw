...
<html>
    ...
    <body> 
        <form id="container" name="formGetAtendente" method="POST" action="app/controller/atendente/procAlterarAtendente.php">
                <fieldset>
                    <legend>&nbsp;&nbsp;Dados do Atendente para alterar: &nbsp;&nbsp;</legend>
                    <br /> 
                    <br />
                    <label>
                        <span>Nome:</span>

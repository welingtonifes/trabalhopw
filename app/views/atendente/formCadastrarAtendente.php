...
<html>
    ...
    <body>      
        <form id="container" name="formCadatrarAtendente" method="POST" action="app/controller/atendente/procInserirAtendente.php">
                <fieldset>
                    <legend>&nbsp;&nbsp;Informe os dados do Atendente: &nbsp;&nbsp;</legend>
                    <br /> 
                    <label>
                        <span>Nome:</span>
